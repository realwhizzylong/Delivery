...
public class VentorInfoActivity extends BaseActivity {
    ...
    public void onDeleteVentor(View view) {
        ...
        new TextDialog(this).showDialog("Notification", "Are you sure to delete this ventor", "Yse", "No", new DialogCallBack() {
            @Override
    ...
    public void onUpdateVentor(View view) {
        ...
        new TextDialog(this).showDialog("Notification", "Are you sure to modify this ventor name", "Yse", "No", new DialogCallBack() {
            @Override
            public void doselectok() {
                super.doselectok();
